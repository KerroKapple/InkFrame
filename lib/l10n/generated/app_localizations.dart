...
abstract class AppLocalizations {
  ...
  /// No description provided for @workspaceHeroTagline.
  ///
  /// In en, this message translates to:
  /// **'AI-driven storyboard desktop tool'**
  String get workspaceHeroTagline;

  /// No description provided for @workspaceHeroSubtitle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @workspaceProjectsHeader.
  ///
  /// In en, this message translates to:
  /// **'My Projects'**
  String get workspaceProjectsHeader;

  /// No description provided for @workspaceProjectsEmpty.
  ///
  /// In en, this message translates to:
  /// **'No projects yet. Tap the FAB to create your first one.'**
  String get workspaceProjectsEmpty;

  /// No description provided for @workspaceNewProject.
  ///
  /// In en, this message translates to:
  /// **'New project'**
  String get workspaceNewProject;

  /// No description provided for @workspaceNewProjectHint.
  ///
  /// In en, this message translates to:
  /// **'Project name'**
  String get workspaceNewProjectHint;

  /// No description provided for @workspaceNewCanvas.
  ///
  /// In en, this message translates to:
  /// **'New canvas'**
  String get workspaceNewCanvas;

  /// No description provided for @workspaceNewCanvasHint.
  ///
  /// In en, this message translates to:
  /// **'Canvas name'**
  String get workspaceNewCanvasHint;

  /// No description provided for @workspaceCanvasCount.
  ///
  /// In en, this message translates to:
  /// **'{count} canvas(es)'**
  String workspaceCanvasCount(int count);

  /// No description provided for @workspaceOpenCanvas.
  ///
  /// In en, this message translates to:
  /// **'Open'**
  String get workspaceOpenCanvas;

  /// No description provided for @workspaceBackToWorkspace.
  ///
  /// In en, this message translates to:
  /// **'Back to workspace'**
  String get workspaceBackToWorkspace;
