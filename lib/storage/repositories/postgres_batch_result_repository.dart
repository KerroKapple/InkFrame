...
class PostgresBatchResultRepository
  ...
  Future<String> create({
    ...
    return guard('create', 'batch_results', () async {
  ...
  Future<Map<String, Object?>?> findById(String id) {
    return guard('findById', 'batch_results', () async {
      final r = await session.execute(
  ...
  Future<Map<String, Object?>?> findBySlot(
    ...
    return guard('findBySlot', 'batch_results', () async {
      final r = await session.execute(
        Sql.named(
  ...
  Future<List<Map<String, Object?>>> listByNode(String nodeId) {
    return guard('listByNode', 'batch_results', () async {
      final r = await session.execute(
        Sql.named(
  ...
  Future<int> update(String id, Map<String, Object?> patch) {
    ...
    return guard('update', 'batch_results', () async {
      ...
      final r = await session.execute(
        Sql.named(
          'UPDATE batch_results SET ${setParts.join(', ')} WHERE id = @id',
        ),
        parameters: params,
      );
  ...
  Future<int> markPromoted({
    ...
    return guard('markPromoted', 'batch_results', () async {
      final r = await session.execute(
        Sql.named(
  ...
  Future<int> hardDelete(String id) {
    return guard('hardDelete', 'batch_results', () async {
      final r = await session.execute(
